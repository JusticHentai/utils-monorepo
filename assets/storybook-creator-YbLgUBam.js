import{j as n}from"./jsx-runtime-u17CrQMm.js";import{useMDXComponents as a}from"./index-C_s77IFb.js";import{C as s}from"./blocks-yt1LEit5.js";import"./iframe-6Q00UePB.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BMbbdbFD.js";const r=`---
...
\`\`\`
`;function t(o){const e={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...a(),...o.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{id:"storybook-creator",children:"storybook-creator"}),`
`,n.jsxs(e.ul,{children:[`
`,n.jsx(e.li,{children:"Storybook 文档创建规范"}),`
`]}),`
`,n.jsx(e.h2,{id:"skillmd",children:"SKILL.md"}),`
`,n.jsxs("details",{children:[n.jsx("summary",{children:"点击展开 SKILL.md 源码"}),n.jsx(s,{language:"markdown",children:r})]}),`
`,n.jsx(e.h2,{id:"技能详解",children:"技能详解"}),`
`,n.jsx(e.h3,{id:"概述",children:"概述"}),`
`,n.jsxs(e.p,{children:["为 ",n.jsx(e.code,{children:"packages/{packageName}/src/{toolName}"})," 下的工具函数创建完整的 Storybook 演示和文档时使用此技能。"]}),`
`,n.jsx(e.h3,{id:"核心功能",children:"核心功能"}),`
`,n.jsxs(e.ul,{children:[`
`,n.jsxs(e.li,{children:[n.jsx(e.strong,{children:"自动生成 Story"}),"：根据工具函数的类型签名和导出，自动创建对应的 ",n.jsx(e.code,{children:".mdx"})," 文档和 ",n.jsx(e.code,{children:".stories.tsx"})," 演示"]}),`
`,n.jsxs(e.li,{children:[n.jsx(e.strong,{children:"统一文档格式"}),"：确保所有工具的 Storybook 文档遵循相同的结构和风格"]}),`
`,n.jsxs(e.li,{children:[n.jsx(e.strong,{children:"演示代码生成"}),"：为每个工具函数生成可交互的演示组件"]}),`
`]}),`
`,n.jsx(e.h3,{id:"使用场景",children:"使用场景"}),`
`,n.jsxs(e.ul,{children:[`
`,n.jsx(e.li,{children:"为新开发的工具函数创建 Storybook story"}),`
`,n.jsx(e.li,{children:"编写工具函数的演示代码"}),`
`,n.jsx(e.li,{children:"生成工具函数的文档页面"}),`
`]})]})}function p(o={}){const{wrapper:e}={...a(),...o.components};return e?n.jsx(e,{...o,children:n.jsx(t,{...o})}):t(o)}export{p as default};
