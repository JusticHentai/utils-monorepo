import{j as n}from"./jsx-runtime-u17CrQMm.js";import{useMDXComponents as o}from"./index-DFEbV2vR.js";import{C as s}from"./blocks-DV7Kb-FB.js";import"./iframe-DzFAswoa.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CJA2SXIP.js";const t=`import { action } from 'storybook/actions'
...
`;function i(e){const r={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...o(),...e.components};return n.jsxs(n.Fragment,{children:[n.jsx(r.h1,{id:"forownright",children:"forOwnRight"}),`
`,n.jsx(r.p,{children:"类似 forOwn，但从后向前遍历自有属性"}),`
`,n.jsx(r.h2,{id:"详细介绍",children:"详细介绍"}),`
`,n.jsxs(r.p,{children:[n.jsx(r.code,{children:"forOwnRight"})," 类似 forOwn，但从后向前遍历自有属性。"]}),`
...
`,n.jsxs(r.p,{children:["点击按钮查看 ",n.jsx(r.code,{children:"forOwnRight"})," 的基本使用效果。"]}),`
...
`,n.jsxs(r.li,{children:[n.jsx(r.strong,{children:"文件职责"}),": ",n.jsx(r.code,{children:"forOwnRight/index.ts"})," 导出 forOwnRight 函数"]}),`
`,n.jsxs(r.li,{children:[n.jsx(r.strong,{children:"核心流程"}),": 类似 forOwn，但从后向前遍历自有属性"]}),`
